...
(function (global, factory) {
  ...
  var Context = /** @class */ (function () {
      ...
      Context.prototype.code = function (html) {
          var isEnabled = this.invoke('codeview.isEnabled');
          if (html === undefined) {
              this.invoke('codeview.sync');
              return isEnabled ? this.layoutInfo.codable.val() : this.layoutInfo.editable.html();
          }
          else {
              if (isEnabled) {
      ...
      Context.prototype.disable = function () {
          ...
          if (this.invoke('codeview.isEnabled')) {
  ...
  */
  ...
  var Dropzone = /** @class */ (function () {
      ...
      Dropzone.prototype.attachDragAndDropEvent = function () {
          ...
          this.documentEventHandlers.onDragenter = function (e) {
              var isCodeview = _this.context.invoke('codeview.isEnabled');
  ...
  var CodeView = /** @class */ (function () {
       ...
       * @return {Boolean}
       */
      CodeView.prototype.isEnabled = function () {
  ...
  var Placeholder = /** @class */ (function () {
      ...
      Placeholder.prototype.update = function () {
          var isShow = !this.context.invoke('codeview.isEnabled') && this.context.invoke('editor.isEmpty');
